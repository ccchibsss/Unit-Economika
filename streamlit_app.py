В коде есть расчеты для недорогих товаров? Проверь как подгружаются тарифы по api. Один раз на лист и от туда тянуться данные к формулам или по другому? ```python
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
============================================================================
